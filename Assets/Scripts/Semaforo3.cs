...
public class Semaforo3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Green = GameObject.Find("G3").GetComponentInChildren<Light>();
        Yellow = GameObject.Find("Y3").GetComponentInChildren<Light>();
        Red = GameObject.Find("R3").GetComponentInChildren<Light>();
    ...
    {
        Debug.Log("passou no vermelho 3");
    }
}