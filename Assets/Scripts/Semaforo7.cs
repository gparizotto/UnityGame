...
public class Semaforo7 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Green = GameObject.Find("G7").GetComponentInChildren<Light>();
        Yellow = GameObject.Find("Y7").GetComponentInChildren<Light>();
        Red = GameObject.Find("R7").GetComponentInChildren<Light>();
    ...
    {
        Debug.Log("passou no vermelho 7");
    }
}