...
public class Semaforo4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Green = GameObject.Find("G4").GetComponentInChildren<Light>();
        Yellow = GameObject.Find("Y4").GetComponentInChildren<Light>();
        Red = GameObject.Find("R4").GetComponentInChildren<Light>();
    ...
    {
        Debug.Log("passou no vermelho 4");
    }
}