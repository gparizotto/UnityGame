...
public class Semaforo2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Green = GameObject.Find("G2").GetComponentInChildren<Light>();
        Yellow = GameObject.Find("Y2").GetComponentInChildren<Light>();
        Red = GameObject.Find("R2").GetComponentInChildren<Light>();
    ...
    {
        Debug.Log("passou no vermelho 2");
    }
}