...
public class Semaforo5 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Green = GameObject.Find("G5").GetComponentInChildren<Light>();
        Yellow = GameObject.Find("Y5").GetComponentInChildren<Light>();
        Red = GameObject.Find("R5").GetComponentInChildren<Light>();
    ...
    {
        Debug.Log("passou no vermelho 5");
    }
}